...
const ModalPosicao3Layout3 = ({ fecharModalPosicao3Layout3, atualizarUploadsSelecionados }) => {
  ...
  useEffect(() => {
    ...
    if (uploadsSelecionados.length > 0) {
      localStorage.setItem('uploadsSelecionados_posicao3Layout3', JSON.stringify(uploadsSelecionados));
    }

    if (Object.keys(tempos).length > 0) {
      localStorage.setItem('temposUploads_posicao3Layout3', JSON.stringify(tempos));
    }
  }, [uploadsSelecionados, tempos]);

  useEffect(() => {
    const uploadsSalvos = localStorage.getItem('uploadsSelecionados_posicao3Layout3');
    if (uploadsSalvos) {
      setUploadsSelecionados(JSON.parse(uploadsSalvos));
    }
    const temposSalvos = localStorage.getItem('temposUploads_posicao3Layout3');
    if (temposSalvos) {
  ...
  return (
    <>
      ...
      <div className="modal-posicao3-layout3">
        <div className="modal2-posicao3-layout3">
          Centro

          <div className='ordem-playlist-posicao3-layout3'>
            <div className='adicionar-upload-posicao3-layout3'>
          ...
          <div className="botao-container">
            <button className='botao-cancel-layout-upload' onClick={fecharModalPosicao3Layout3}>Fechar</button>
...
export default ModalPosicao3Layout3;
