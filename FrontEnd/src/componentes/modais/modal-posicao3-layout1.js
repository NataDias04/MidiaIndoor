...
const ModalPosicao3Layout1 = ({ fecharModalPosicao3Layout1, atualizarUploadsSelecionados }) => {
  ...
  return (
    <>
      ...
      <div className="modal-posicao3-layout1">
        <div className="modal2-posicao3-layout1">
          Baixo

          <div className='ordem-playlist-posicao3-layout1'>
            <div className='adicionar-upload-posicao3-layout1'>
          ...
          <div className="botao-container">
            <button className='botao-cancel-layout-upload' onClick={fecharModalPosicao3Layout1}>Fechar</button>
...
export default ModalPosicao3Layout1;
